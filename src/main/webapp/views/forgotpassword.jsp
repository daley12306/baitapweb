		...
		<div class="content-form-page">
			<div class="row">
				<div class="col-md-7 col-sm-7">
					<form action="/btweb/forgotpassword" class="form-horizontal form-without-legend" method="post">
						...
						<div class="form-group">
							<label for="password" class="col-lg-4 control-label">Enter
								new password</label>
							<div class="col-lg-8">
						...
						<div class="form-group">
							<label for="password" class="col-lg-4 control-label">Re-enter
								new password</label>
							<div class="col-lg-8">
								<input type="password" class="form-control" name="psw-repeat" id="psw-repeat">
							</div>
						</div>
						<div class="row">
							<div
