<%@ page language="java" contentType="text/html; charset=UTF-8"
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        ...
                        <li><a href="/btweb/login">Log In</a></li>
                    </ul>
                </div>
                <!-- END TOP BAR MENU -->
            </div>
    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href="/btweb/home"><img src="${URL}assets/frontend/layout/img/logos/logo-shop-red.png" alt="Metronic Shop UI"></a>
